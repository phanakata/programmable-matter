...
def set_random(L,Np,Nb,Nd):
  s = gsd.hoomd.Snapshot()
  s.particles.N = Np
  s.particles.types = ['1','2']
...
#    z = 0.
  s.particles.position.append((0,0,0))
  s.particles.position.append((1,0,0))
  s.particles.position.append((0.5,0.5,0)) 
  s.particles.position.append((1.5,0.5,0))

  s.bonds.group.append((0,1))
  s.bonds.group.append((0,2))
  s.bonds.group.append((1,2))
  s.bonds.group.append((2,3))
  s.bonds.group.append((1,3))

  s.dihedrals.N = Nd
  s.dihedrals.group.append((1,2,0,3))
